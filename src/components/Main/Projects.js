    ...
    return (
      <section id="projects" className="projects-section section text-center">
        <div className="container">
          ...
          <div className="album">
            <a href="https://unitedmasters.com/off-ki-productions5885/r/bed-of-roses/Aw2UANNhg369" target="_blank"><img className="album-cover" src={BedOfRosesAlbum} style={{height: "300px", width: "300px"}}></img></a>
          </div>
